...
velPub = rospy.Publisher('/drone/joint_motor_controller/command', Float64MultiArray, queue_size=4)
...
PoseSub = rospy.Subscriber('/gazebo/model_states',ModelStates,control_drone,(velPub, err_rollPub, err_pitchPub, err_yawPub))
