...
folder_frame_string1 = 'drone_images/Crazy_01/frame';
folder_frame_string2 = 'drone_images/Crazy_05/frame';

filename1 = [folder_frame_string sprintf('%04d',0) '.jpg'];
filename2 = [folder_frame_string sprintf('%04d',0) '.jpg'];
